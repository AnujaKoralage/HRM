...
import {NewAttendanceAdminComponent} from "./new-attendance-admin/new-attendance-admin.component";
...
const routes: Routes = [
  ...
  children: [
    ...
    { path: "new-attendance-admin", component: NewAttendanceAdminComponent },
  ],
 }];
