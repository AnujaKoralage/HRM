...
export class routes {
  ...
  public static get attendanceadminnew(): string {
    return this.baseUrl + '/employees/new-attendance-admin';
  }
  ...
  public static get fileUpload(): string {
    return this.baseUrl + '/forms/file-upload';
  }
  public static get mat_select(): string {
    return this.baseUrl + '/forms/mat-select';
  }
