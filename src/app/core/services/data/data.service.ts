...
export class DataService {
  ...
  public getAttendanceNew(): Observable<apiResultFormat> {
    return this.http.get<apiResultFormat>('assets/JSON/new-attendance-admin.json').pipe(
      map((res: apiResultFormat) => {
        return res;
      })
    );
      ...
      menu: [
        {
          ...
          subMenus: [
            ...
            {
              menuValue: 'Attendance (Admin-New)',
              route: routes.attendanceadminnew,
              base: 'new-attendance-admin',
              currentActive: true,
            },
            {
